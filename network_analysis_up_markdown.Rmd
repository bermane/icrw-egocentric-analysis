...
# ego igraph file
ego_igraph_f <- "/Users/bermane/Team Braintree Dropbox/Ethan Berman/R Projects/icrw-egocentric-analysis/data/ego_igraph_up.rda"

# alter igraph file
alter_igraph_f <- "/Users/bermane/Team Braintree Dropbox/Ethan Berman/R Projects/icrw-egocentric-analysis/data/alter_igraph_up.rda"

# ego data file
ego_data_f <- "/Users/bermane/Team Braintree Dropbox/Ethan Berman/R Projects/icrw-egocentric-analysis/data/SNA study_EGO_clean_Uttar Pradesh_08112022.xlsx"

# alter data file
alter_data_f <- "/Users/bermane/Team Braintree Dropbox/Ethan Berman/R Projects/icrw-egocentric-analysis/data/SNA study_ALTER_clean_Uttar Pradesh_08112022.xlsx"

# ego pc data file
ego_pc_f <- "data/ego_pc_complete_up_08112022.xlsx"

# duplicate id file
dup_id_f <- 'data/duplicate_ids_up_07112022.xlsx'
...
##### We cannot calculate length of relationship in the same way because we don't have Alter's age/year married, which is necessary for cases where the response was "known since marriage"
