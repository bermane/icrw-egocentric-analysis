...
df %<>% mutate(residence = recode(residence,
                                  `1.0` = 'Same HH',
                                  `2.0` = 'Same Village',
                                  `3.0` = 'Another Village within same District',
...
df %<>% mutate(value = recode(value,
                              ...
                              `2.0` = 'Bicycle',
                              `3.0` = 'Rickshaw',
                              `4.0` = 'Autorickshaw or other motor vehicle',
                              `5.0` = 'Do not travel, only talk over phone'))
...
# recode
df %<>% mutate(value = recode(value,
                              `1.0` = 'Mainly in person',
                              `2.0` = 'Mainly telephone',
                              `3.0` = 'Both'))
...
df1 %<>% mutate(value = recode(value,
                               `1.0` = 'Daily',
                               `2.0` = 'At least 3x/week',
                               `3.0` = '1x/week',
                               `4.0` = '1x/month',
                               `5.0` = '1x/every 3 months',
                               `6.0` = '1x/every 6 months',
                               `7.0` = '1x/a year'))
...
df2 %<>% mutate(value = recode(value,
                               `1.0` = 'At least once a week',
                               `2.0` = 'At least once a month',
                               `3.0` = 'At least once in 6 months',
                               `4.0` = 'At least once a year',
                               `5.0` = 'At least once in a few years'))
...
df %<>% mutate(value = recode(value,
                              `1.0` = 'Yes',
                              `2.0` = 'No',
                              `9.0` = 'Do not know/do not remember'))
...
# recode
df %<>% mutate(value = recode(value,
                              `1.0` = 'Encouraged to use FP methods',
                              `2.0` = 'Discouraged to use FP methods',
                              `3.0` = 'Neither encouraged nor discouraged'))
